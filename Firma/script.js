...
function renderOrder(orderNumber, i) {
  ...
  orderList.innerHTML += `
  <ul class="order" id="order" onclick="openDetail(event)"> 
    <p id="order-id${i}">${orderNumber}</p>
    <div class="btn-container">
      <button class="delete-btn" id="delete-order" onclick="deleteOrder(${i})" >Löschen</button>
      <button class="amount-btn" onclick="calcAmount('${orderNumber}')">Menge</button>
    </div>
  </ul>`
}
